    ...
    <header className="shadow">
      <div className="flex items-center justify-between p-8 bg-white container mx-auto px-5">
        ...
        <nav className="hidden md:flex space-x-4">
          ...
          <Link href="/blog/review/1" className="relative pb-1 after:block after:absolute after:-bottom-1 after:left-0 after:w-full after:h-[2px] after:bg-black after:scale-x-0 after:origin-left after:transition-transform after:duration-300 hover:after:scale-x-100">Review</Link>
